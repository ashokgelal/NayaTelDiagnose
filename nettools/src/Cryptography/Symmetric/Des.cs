...
namespace nettools.Cryptography.Symmetric
{
    ...
    internal static class Des
    {
        ...
        [Obsolete]
        public static string EncryptDes(this string input, string password, int iterations = 500000)
        {
            ...
            using (Rfc2898DeriveBytes passBytes = new Rfc2898DeriveBytes(password, 16, iterations))
            {
                ...
                using (SymmetricAlgorithm algo = SymmetricAlgorithm.Create("DES"))
                {
        ...
        [Obsolete]
        public static string DecryptDes(this string input, string password, int iterations = 500000)
        {
