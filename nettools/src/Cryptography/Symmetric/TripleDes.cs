...
namespace nettools.Cryptography.Symmetric
{
    ...
    internal static class TripleDes
    {
        ...
        public static string EncryptTripleDes(this string input, string password, int iterations = 500000)
        {
            ...
            using (Rfc2898DeriveBytes passBytes = new Rfc2898DeriveBytes(password, 16, iterations))
            {
                ...
                using (SymmetricAlgorithm algo = SymmetricAlgorithm.Create("TripleDES"))
                {
        ...
        public static string DecryptTripleDes(this string input, string password, int iterations = 500000)
        {
