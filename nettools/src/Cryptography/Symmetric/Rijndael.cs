...
namespace nettools.Cryptography.Symmetric
{
    ...
    internal static class Rijndael
    {

        public static string EncryptRijndael(this string input, string password, int iterations = 500000)
        {
        ...
        public static string DecryptRijndael(this string input, string password, int iterations = 500000)
        {
