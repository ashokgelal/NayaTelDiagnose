...
namespace nettools.ThirdParty.CmdLineTokenizer
{

    /// <summary>
    /// Replacement for string[] args which uses CommandLineToArgvW and its funny rules.
    /// </summary>
    /// <see cref="https://github.com/nelyom/cmdLineTokenizer/blob/master/LICENSE"/>
    public static class Tokenizer
    {
        ...
        public static List<string> TokenizeCommandLineToList(string commandLine)
        {
            ...
            /// (nettools: not needed in this program)
            // tokens.RemoveAt(0);
